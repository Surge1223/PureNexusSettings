...
public class StatusbarFragment extends PreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int batteryShowPercent = Settings.System.getInt(resolver, STATUS_BAR_SHOW_BATTERY_PERCENT, 0);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mStatusBarBattery) {
            ...
            Settings.System.putInt(resolver, STATUS_BAR_BATTERY_STYLE, batteryStyle);
            ...
            Settings.System.putInt(resolver, STATUS_BAR_SHOW_BATTERY_PERCENT, batteryShowPercent);
